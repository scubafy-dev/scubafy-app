      ...
      <div className="space-y-4">
        ...
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
          <Link href="/customers" className="dashboard-card hover:bg-accent transition-colors">
            ...
            <p className="dashboard-card-subtitle">+{stats.bookingsChange}% from last month</p>
          </Link>
          <div className="dashboard-card">
            <div className="flex items-center justify-between mb-2">
              <h3 className="dashboard-card-title">Active Divers</h3>
            </div>
            <div className="dashboard-card-value">{stats.activeDivers}</div>
            <p className="dashboard-card-subtitle">+{stats.newDivers} new this week</p>
          </div>
          <Link href="/dive-trips" className="dashboard-card hover:bg-accent transition-colors">
            ...
            <div className="dashboard-card-value">{stats.upcomingDives}</div>
          ...
          <Link href="/finances" className="dashboard-card hover:bg-accent transition-colors">
            ...
            <div className="dashboard-card-value">${stats.revenue.toLocaleString()}</div>
            <p className="dashboard-card-subtitle">+{stats.revenueChange}% from last month</p>
          </Link>
        </div>
