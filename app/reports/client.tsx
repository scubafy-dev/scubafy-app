...
import { allCentersReports, reportsByCenter } from "@/lib/mock-data/reports";
...
export default function ReportsClient() {
    ...
    return (
        <DashboardShell>
            <DashboardHeader
                heading="Dive Reports"
                text="View and manage dive reports across your centers."
            >
